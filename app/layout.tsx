...
const banner = <Banner storageKey="some-key">Megérkezett a Planitapp dokumentációja. 🎉</Banner>
const navbar = (
  <Navbar
    logo={<b>Planitapp</b>}
...
const footer = <Footer>MIT {new Date().getFullYear()} © Planitapp. Minden jog fenntartva.</Footer>
    ...
    >
      ...
      <body>
        <Layout
          ...
          lastUpdated={<LastUpdated locale='hu'>Utoljára frissítve: </LastUpdated>}
