...
Az alkalmazás authentikációja az [Auth.js v5 (beta)](https://authjs.dev/) könyvtárat használja. Az **Auth.js** egy rugalmas, biztonságos authentikációs megoldást biztosít különböző bejelentkezési módszerek támogatásával.
